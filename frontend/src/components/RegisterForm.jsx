...
const RegisterForm = ({ state }) => {
    ...
    return (
        <div className="w-full max-w-md mx-auto mt-10">
            <form onSubmit={handleSubmit} className="bg-black/40 backdrop-blur-xl border border-zinc-800 rounded-2xl p-8 shadow-xl">
                ...
                <div className="mb-4">
                    <label className="block text-gray-300 text-sm font-semibold mb-2">Enter your fullname</label>
                    <input
